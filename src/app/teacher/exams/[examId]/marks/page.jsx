// // app/teacher/exams/[examId]/marks/page.js
...
// import { Loader, AlertCircle, CheckCircle, ChevronLeft, Search, Filter } from 'lucide-react';
...
//   // Initialize marks from fetched students
//   useEffect(() => {
...
//           student.subject_marks.forEach((sm) => {
//             initialMarks[student.student_id][sm.subject_id] = sm.marks_obtained !== '' ? sm.marks_obtained : '';
//           });
//         }
//       });
...
//         marks_obtained: parseFloat(marks[student.student_id]?.[subject.subject_id]) || 0
//       }));
...
//             {exam?.class_name || 'Class'} • {exam?.subject_schedules?.length || 0} Subjects • {students.length} Students
//           </p>
//         </div>
