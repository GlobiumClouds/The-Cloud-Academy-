...
// const PLAN_PALETTE = {
//   basic:      { bg: 'bg-slate-50',   border: 'border-slate-200',   accent: 'text-slate-600',   iconBg: 'bg-slate-100' },
//   standard:   { bg: 'bg-blue-50',    border: 'border-blue-200',    accent: 'text-blue-600',    iconBg: 'bg-blue-100' },
//   premium:    { bg: 'bg-amber-50',   border: 'border-amber-200',   accent: 'text-amber-600',   iconBg: 'bg-amber-100' },
//   enterprise: { bg: 'bg-purple-50',  border: 'border-purple-200',  accent: 'text-purple-600',  iconBg: 'bg-purple-100' },
// };
...
//           {[1, 2, 3].map((i) => <div key={i} className="h-80 rounded-2xl border bg-muted animate-pulse" />)}
//         </div>
//       ) : filtered.length === 0 ? (
//         <EmptyState
//           icon="📦"
...
//   return (
//     <div className={cn(
//       'relative flex flex-col rounded-2xl border-2 p-4 shadow-sm transition-all hover:shadow-md',
...
//         {plan.is_popular    && <span className="rounded-full bg-amber-400 px-2 py-0.5 text-[10px] font-bold text-white">🔥 Popular</span>}
//         {!plan.is_active    && <span className="rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-semibold text-red-600">Inactive</span>}
//         {!plan.is_published && <span className="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-500">Draft</span>}
//       </div>

//       {/* Header */}
//       <div className="flex items-center gap-2.5 mb-3 pr-16">
//         <div className={cn('shrink-0 rounded-xl p-2 shadow-sm', palette.iconBg)}>
//           <PlanIcon name={plan.code ?? plan.name} className={cn('size-4', palette.accent)} />
//         </div>
//         <div className="min-w-0">
//           <h3 className="font-bold text-slate-800 truncate leading-tight">{plan.name}</h3>
//           <div className="flex items-center gap-1.5 mt-0.5">
//             {plan.code && <span className="text-[10px] font-mono text-muted-foreground uppercase">{plan.code}</span>}
//             <span className={cn('rounded-full border px-1.5 py-px text-[10px] font-semibold', cycleStyle)}>
//               {plan.cycle}
//             </span>
//           </div>
//         </div>
...
//       {/* Pricing */}
//       <div className="mb-3">
//         <p className={cn('text-2xl font-extrabold leading-tight', palette.accent)}>
...
//             <Clock size={10} />{plan.trial_days}-day free trial
//           </p>
//         )}
//       </div>
...
//         ].map((row) => (
//           <div key={row.label} className="flex items-center gap-1.5 rounded-lg bg-white/70 px-2 py-1">
...
//               <p className="text-xs font-semibold text-slate-700 truncate">{row.val}</p>
//             </div>
//           </div>
//         ))}
//       </div>
...
//           <p className="text-[11px] text-muted-foreground pl-4">+{enabledFeat.length - 5} more</p>
//         )}
//         {enabledFeat.length === 0 && (
//           <p className="text-[11px] text-muted-foreground italic">No features enabled</p>
//         )}
//       </div>

//       {/* Toggle row */}
//       <div className="mb-3 rounded-xl bg-white/60 border border-white/80 p-2 space-y-1.5">
//         <ToggleRow icon={<Power size={11} />} label="Active"    checked={!!plan.is_active}    loading={toggling === 'active'}  onChange={() => onToggle('active')} />
//         <ToggleRow icon={<Eye   size={11} />} label="Published" checked={!!plan.is_published} loading={toggling === 'publish'} onChange={() => onToggle('publish')} />
//         <ToggleRow icon={<Flame size={11} />} label="Popular"   checked={!!plan.is_popular}   loading={toggling === 'popular'} onChange={() => onToggle('popular')} />
//       </div>

//       {/* Actions */}
//       <div className="flex gap-1.5 mt-auto">
//         <Button size="sm" variant="outline" className="flex-1 gap-1 text-xs h-8" onClick={onEdit}>
//           <Pencil size={11} /> Edit
//         </Button>
//         <Button
...
// function ToggleRow({ icon, label, checked, loading, onChange }) {
//   return (
//     <div className="flex items-center justify-between">
//       <div className="flex items-center gap-1.5 text-xs text-slate-600">{icon}{label}</div>
//       <Switch
//         checked={checked}
